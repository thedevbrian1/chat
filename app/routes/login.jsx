import { Form, Link, isRouteErrorResponse, redirect, useActionData, useNavigation, useRouteError } from "@remix-run/react";
...
export default function Login() {
    ...
    return (
        <main className="h-screen w-full bg-[url('https://images.unsplash.com/photo-1511497584788-876760111969?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat">
                        ...
                        <fieldset className="space-y-4">
                            <FormSpacer>
                                ...
                                <Input
                                    ...
                                    className={`focus-visible:ring-4 focus-visible:ring-brand-brown transition ease-in-out duration-300 ${actionData?.fieldErrors?.email ? 'border border-red-500' : ''}`}
                                />
                            ...
                            <Button type="submit" className="w-full bg-[#C181B9] hover:bg-[#d4a7ce] transition ease-in-out duration-300 text-black">
                                {isSubmitting ? <span className="w-10"><ThreeDots /></span> : 'Log In'}
                            </Button>
                        </fieldset>
                    </Form>
                </div>
